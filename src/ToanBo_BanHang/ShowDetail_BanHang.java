 ...
 * @author ADMIN
 */
public class ShowDetail_BanHang {
    ...
    public ShowDetail_BanHang() {
    }

    public ShowDetail_BanHang(String Ma_HD, String Ma_TK, Date NgayLap_HD, float TongTien, String HinhThuc_HD, String TrangThai, String Ma_KM, float SoTienKhachTra_HD, String Ma_KH, String Ten_KH, int DiemTichLuy, int TichDiem) {
        this.Ma_HD = Ma_HD;
        this.Ma_TK = Ma_TK;
