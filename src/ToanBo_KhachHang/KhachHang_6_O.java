...
public class KhachHang_6_O {
    ...
    public KhachHang_6_O() {
    }

    public KhachHang_6_O(String Ma_KH, String Ten_KH, String SDT_KH, String Email_KH, Date NgayTao_KH, int DiemTichLuy) {
        this.Ma_KH = Ma_KH;
        this.Ten_KH = Ten_KH;
        this.SDT_KH = SDT_KH;
